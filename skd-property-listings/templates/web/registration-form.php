...
if (!in_array($user_type, ['vda', 'studio', 'employer'])) {
    $user_type = 'vda';
}
...
<div class="skd-registration-wrapper">
    <div class="skd-registration-container">
        ...
        <div class="skd-role-tabs">
            ...
            <a href="?type=studio" class="skd-role-tab <?php echo $user_type === 'studio' ? 'active' : ''; ?>">
                <span class="role-icon">🏢</span>
                <span class="role-title">Studio/Agency</span>
                <span class="role-desc">Register your design studio</span>
            </a>
            ...
            <form id="skd-registration-form" class="skd-form">
                    ...
                    <div class="skd-form-group <?php echo $field['required'] ? 'required' : ''; ?>">
                        ...
                        <div class="skd-password-wrapper">
                            ...
                            <button type="button" class="skd-toggle-password" aria-label="Toggle password visibility">
                                ...
                                <svg class="eye-slash-icon" style="display:none;" width="20" height="20"
                        ...
                        <input type="<?php echo esc_attr($field['type']); ?>"
                            name="<?php echo esc_attr($field_name); ?>" id="<?php echo esc_attr($field_name); ?>"
                            placeholder="<?php echo esc_attr($field['placeholder'] ?? ''); ?>"
                            <?php echo $field['required'] ? 'required' : ''; ?>>
                        <?php endif; ?>
                    </div>
                ...
                <div class="skd-form-group">
                    <label class="skd-checkbox-wrapper">
                        ...
                        <span class="skd-checkbox-label-text">I agree to the <a
                                href="<?php echo home_url('/terms-of-service/'); ?>" target="_blank">Terms of
                                Service</a> and <a href="<?php echo home_url('/privacy-policy/'); ?>"
    ...
    $('#skd-registration-form').validate({
        ...
        submitHandler: function(form) {
            ...
            var formData = {
                ...
                tagline: $form.find('[name="tagline"]').val(),
