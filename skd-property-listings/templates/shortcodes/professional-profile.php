        ...
        <div class="skd-hero-content">
            ...
            <div class="skd-profile-actions">
                ...
                <?php if ($current_user_type === 'employer'): ?>
                    <button class="skd-btn skd-btn-outline save-vda-btn <?php echo $is_saved ? 'saved' : ''; ?>"
                        data-vda-id="<?php echo $professional->user_id; ?>"
                ...
                <?php elseif (!is_user_logged_in()): ?>
                    <a href="<?php echo home_url('/login/'); ?>" class="skd-btn skd-btn-outline">
...
<script>
    ...
    function saveToFavorites(professionalId) {
        // Legacy function - replaced by save-vda-btn click handler
